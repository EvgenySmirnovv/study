...
def test_param_line_pass(line, driver):
...
def test_english_upper_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
...
def test_english_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
...
def test_russian_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим кириллицу
    driver.find_element(By.ID, 'password').send_keys(russian_chars())
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
    # Принимает русские буквы
    assert data == russian_chars()


def test_russian_upper_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    ...
    # Вводим кириллицу
    driver.find_element(By.ID, 'password').send_keys(up)
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
...
def test_chinese_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим китайские символы
    driver.find_element(By.ID, 'password').send_keys(chinese_chars())
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
...
def test_special_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим спецсимволы
    driver.find_element(By.ID, 'password').send_keys(special_chars())
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
...
def test_generate_string_pass_255(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим необходимое число символов
    driver.find_element(By.ID, 'password').send_keys(generate_string(255))
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
...
def test_generate_string_pass_1000(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим необходимое число символов
    driver.find_element(By.ID, 'password').send_keys(generate_string(1000))
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
    # Строка должна принимать меньшое количество символов
    assert len(data) != 1000


def test_num_chars_pass(driver):
    driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=account_b2c'
               '&redirect_uri=https://b2c.passport.rt.ru/account_b2c/login?theme%3Dlight&response_type=code&scope'
               '=openid&state=ac430121-8a61-410e-8d51-016d4d0a1a5b&theme=light&auth_type')
    driver.implicitly_wait(5)
    # Вводим цифры
    driver.find_element(By.ID, 'password').send_keys(num_chars())
    time.sleep(1)
    # Выводим текст в переменную
    data = driver.find_element(By.ID, 'password').get_attribute('value')
    print(data)
